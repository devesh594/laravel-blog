                                    ...
                                    <form wire:submit="submit">
                                        ...
                                        <div class="form-group mb-4 pb-2">
                                            <label for="message" class="form-label">Write
                                                Message</label>
                                            <textarea class="form-control shadow-none" id="message" wire:model="message"
                                ...
                                <div class="contact-info">
                                    <div class="block mt-0">
                                        ...
                                        <div class="content">Call Us We Will Be Happy To Help
                                            <br> <a href="tel:+XXX111222">+91 9133111222</a>
                                            <br>Monday - Friday
                                            <br>9AM TO 8PM Eastern Time
                                        </div>
                                    </div>
                                    <div class="block mt-4">
                                        <h4 class="h5">India Office</h4>
                                        <div class="content">Park Street 455 Salt lake
                                            <br>Mansarovar, Jaipur
                                            <br>Rajasthan 302016
                                        </div>
                                    </div>
                                    <div class="block mt-4">
