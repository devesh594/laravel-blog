            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="block text-center text-lg-start pe-0 pe-xl-5">
                        ...
                        <a type="button" class="btn btn-primary" href="{{ route('servicePage', 1) }}" wire:navigate
                            data-bs-toggle="modal" data-bs-target="#applyLoan">See More<span style="font-size: 14px"
